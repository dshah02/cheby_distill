#!/bin/sh
#SBATCH --job-name=train_pair_gen_cpu # create a short name for your job
#SBATCH --output=slurm/slurm_output/train_pair_gen_cpu/%x_%j.out
#SBATCH --error=slurm/slurm_output/train_pair_gen_cpu/%x_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
